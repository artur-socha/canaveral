...
import com.codewise.canaveral2.core.runtime.RunnerConfiguration.MockProvidersConfiguration;
...
public final class Runner
{
    ...
    {
        MockProvidersConfiguration mockProvidersConfiguration = configuration.getMockProvidersConfiguration();
