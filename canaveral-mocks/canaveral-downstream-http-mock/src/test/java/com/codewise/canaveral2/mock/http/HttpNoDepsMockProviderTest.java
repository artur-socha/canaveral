...
import com.codewise.canaveral2.core.runtime.DummyRunnerContext;
import com.codewise.canaveral2.mock.http.HttpRawRequest.Header;
import com.codewise.canaveral2.mock.http.MockRuleProvider.Body;
...
class HttpNoDepsMockProviderTest
{
    ...
    public void shouldGetResource()
    {
        ...
        assertThat(capturedRequests).extracting(HttpRawRequest::getMethod).containsOnly(Method.GET);
